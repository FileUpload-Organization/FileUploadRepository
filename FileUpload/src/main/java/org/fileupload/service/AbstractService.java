...
import org.fileupload.util.JpaUtil;
...
public abstract class AbstractService<T> {
	...
	@SuppressWarnings("unchecked")
	public T getEntityWithNamedQuery(String namedQueryName, String username, String password) {
		try {
	 ...
	 *            named query name from entity
	 * @param parameters
	 *            parameters map for named query
	 * @return result list
	 */
